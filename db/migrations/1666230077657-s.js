module.exports = class s1666230077657 {
  name = 's1666230077657'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "round_collator" ("id" character varying NOT NULL, "self_bond" numeric NOT NULL, "total_bond" numeric NOT NULL, "commission" numeric NOT NULL, "apr" numeric, "apr_techn_numerator" numeric, "apr_techn_denominator" numeric, "nominators_count" integer NOT NULL, "staker_id" character varying NOT NULL, "round_id" character varying NOT NULL, CONSTRAINT "PK_32b73164cfc62741feb236d9895" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "staker" ("id" character varying NOT NULL, "stash_id" character varying NOT NULL, "commission" numeric, "active_bond" numeric NOT NULL, "total_reward" numeric NOT NULL, "apr24h" numeric, CONSTRAINT "REL_828b14269265a736e4fef52ce2" UNIQUE ("stash_id"), CONSTRAINT "PK_13561f691b22038cfa606fe1161" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "history_element" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "type" integer NOT NULL, "amount" numeric NOT NULL, "staker_id" character varying, "round_id" character varying NOT NULL, CONSTRAINT "PK_b10b09ee684b794e1ca6dc2470c" PRIMARY KEY ("id"))`)
